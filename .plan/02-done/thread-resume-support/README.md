...
> Repo: /workspaces/codex-session | Status: done
...
| ----- | ------------------------- | ----------------- | ------ | --------- |
| 01    | `01-thread-index.md`      | Thread index      | done   | 2026-05-27 |
| 02    | `02-capture-wiring.md`    | Capture wiring    | done   | 2026-05-27 |
| 03    | `03-resume-routing.md`    | Resume routing    | done   | 2026-05-27 |
| 04    | `04-docs-dotfiles.md`     | Docs & dotfiles   | done   | 2026-05-27 |
