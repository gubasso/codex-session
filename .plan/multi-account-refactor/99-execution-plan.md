...
| # | Name | Plan input | Difficulty | Mode | Est duration |
|---|---|---|---|---|---|
| R1 | Foundation: persistent CODEX_HOME + group-id fallback (bug fix) | [10-phase-foundation.md](10-phase-foundation.md) | Medium | `/prex -ar` | 25–35 min |
| R2 | Multi-account top-level CLI + account-aware path resolution | [11-phase-multiaccount-cli.md](11-phase-multiaccount-cli.md) | Medium | `/prex -a` | 25–35 min |
| R3 | Quota reader + scoring selector | [12-phase-quota-selector.md](12-phase-quota-selector.md) | High | `/prex -ar` | 30–45 min |
| R4 | Reactive 429 failover + retry-with-rotation + AuthBridge cleanup | [13-phase-failover.md](13-phase-failover.md) | Medium-High | `/prex -ar` | 30–40 min |
